...
let refrescar=()=>{
  ...
  document.getElementById('totalMeme').textContent = formatoNum((formatoNum(document.getElementById('vGIB').textContent,5)+formatoNum(document.getElementById('vDosa').textContent,5)+formatoNum(document.getElementById('vCKNBLZ').textContent),5),2);
}
