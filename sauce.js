...
const WBTCId = 'hedera-hashgraph/pools/0xd376f1f8c4e5151a0229336457688cd2407da60f';
...
let refrescar=()=>{
  inicializar();
  document.getElementById('USDC').textContent = 1;
...
/*  document.getElementById('Jeet').textContent = formatoNum(parseFloat(document.getElementById('spCotJeet').innerText),5);
  ...
  document.getElementById('totalSauce').textContent = formatoNum(parseFloat(calcularTotal()/document.getElementById('spCotSauce').innerText),0);
